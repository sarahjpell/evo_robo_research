...
class OBJECT:
    ...
    def Send_To_Simulator(self, simulator):
        ...
        # if not (self.parent.myDepth == 0 and self.child.myDepth == 1):
            ...
            # self.ballID = simulator.send_cylinder(x=self.parent.x + positionOffset[0],
            #                                       y=self.parent.y + positionOffset[1],
            #                                       z=self.parent.z + positionOffset[2],
        ...
        #                                   r1=r1, r2=r2, r3=r3,
        #                                   length=length, radius=c.radius,
        #                                   draw_offset_x=drawOffset[0], draw_offset_y=drawOffset[1],
